...
DEVICE=${DEVICE:-cuda}
CONFIG=${CONFIG:-configs/exp_multilingual_safety_v2.yaml}
...
SCHEMA_CHECK_OUT=${SCHEMA_CHECK_OUT:-"outputs/multilingual_siren_v2/_dataset_schema_check"}
...
python analysis/analyze_multilingual_siren_results.py \
  --run_dir "outputs/multilingual_siren_v2/${MODEL}" \
  --out_dir "outputs/multilingual_siren_v2/${MODEL}/analysis"
